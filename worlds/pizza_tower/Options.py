...
class RandomizeTransfos(Toggle):
    ...
    Enabling this setting in combination with moveset randomization will place 2 movement abilities at the beginning of your world to prevent issues due to a restrictive start.
    """
