...
def set_rules(multiworld: MultiWorld, world: PizzaTowerWorld, options: PTOptions, toppins: int, pumpkins: int):
    ...
    #Crust Cove
        "Crust Cove Complete": (
            ...
            "SJUMP+SLAM+BARR | SJUMP+CRUSH+BARR | SJUMP+TORN+BARR | BOUNCE+UPPER+SLAM+BARR | BOUNCE+UPPER+TORN+BARR | BOUNCE+CRUSH+BARR",
            "CRUSH+BARR | SJUMP+TORN+BARR | SJUMP+SLAM+BARR | BOUNCE+BARR"
        ),
        "Crust Cove Mushroom Toppin": (
            "SJUMP | CLIMB", 
            "SJUMP | CLIMB", 
            "SJUMP | BOUNCE+UPPER | BOUNCE+CRUSH", 
            "CRUSH | SJUMP | BOUNCE"
        ),
        "Crust Cove Cheese Toppin": (
            "SJUMP+BARR | CLIMB+BARR", 
            "SJUMP+BARR | CLIMB+BARR", 
            "SJUMP+BARR | BOUNCE+UPPER+BARR | BOUNCE+CRUSH+BARR", 
            "CRUSH+BARR | SJUMP+BARR | BOUNCE+BARR"
        ),
        ...
        "Crust Cove Secret 3": (
            ...
            "SJUMP+SLAM+TAUNT+BARR | SJUMP+CRUSH+TAUNT+BARR | SJUMP+TORN+TAUNT+BARR | BOUNCE+UPPER+SLAM+TAUNT+BARR | BOUNCE+UPPER+TORN+TAUNT+BARR | BOUNCE+CRUSH+TAUNT+BARR", 
            "CRUSH+TAUNT+BARR | SJUMP+TORN+TAUNT+BARR | SJUMP+SLAM+TAUNT+BARR | BOUNCE+TAUNT+BARR"
        ),
        "Crust Cove Treasure": (
            "SJUMP | CLIMB", 
            "SJUMP | CLIMB", 
        ...
        "Chef Task: Blowback": (
            ...
            "SJUMP+TAUNT | CLIMB+TAUNT", 
            "SJUMP+TAUNT | BOUNCE+TAUNT+UPPER | BOUNCE+TAUNT+CRUSH", 
            "CRUSH+TAUNT | SJUMP+TAUNT | BOUNCE+TAUNT"
        ),
        "Chef Task: X": (
            "CLIMB+SLAM+BARR", 
            "SLAM+SJUMP | SLAM+CLIMB", 
            "SJUMP+SLAM+BARR | SJUMP+CRUSH+BARR | BOUNCE+UPPER+SLAM+BARR | BOUNCE+CRUSH+BARR", 
    ...
    #Peppibot Factory
        ...
        "Chef Task: There Can Be Only One": (
            "LAP2+SJUMP+CLIMB+SLAM+GRAB+BOX | LAP2+SJUMP+UPPER+SLAM+GRAB+BOX", 
            "LAP2+SJUMP+SLAM+BOX | LAP2+CLIMB+GRAB+SLAM+BOX | LAP2+CLIMB+UPPER+SLAM+BOX", 
            "LAP2+SJUMP+SLAM+GRAB+BOX | LAP2+SJUMP+TORN+GRAB+BOX | LAP2+SJUMP+CRUSH+GRAB+BOX", 
