...
def set_rules(multiworld: MultiWorld, world: World, options: PTOptions, toppins: int, pumpkins: int):
    ...
    #Deep-Dish 9
        ...
        "Deep-Dish 9 Mushroom Toppin": (
			...
			"SLAM+ROCKET | CRUSH+ROCKET | BOUNCE+ROCKET | TORN+ROCKET"
		),
        "Deep-Dish 9 Cheese Toppin": (
			"SLAM+SJUMP+ROCKET+BUBB | SLAM+CLIMB+ROCKET+BUBB", 
			"SLAM+UPPER+ROCKET | SLAM+SJUMP+ROCKET | SLAM+CLIMB+ROCKET", 
        ...
        "Deep-Dish 9 Tomato Toppin": (
			"SLAM+SJUMP+ROCKET+BUBB | SLAM+CLIMB+ROCKET+BUBB", 
			"SLAM+SJUMP+ROCKET | SLAM+CLIMB+ROCKET", 
			"SLAM+SJUMP+ROCKET+BUBB | TORN+SJUMP+ROCKET+BUBB | CRUSH+SJUMP+ROCKET+BUBB | SLAM+BOUNCE+ROCKET+BUBB | TORN+BOUNCE+ROCKET+BUBB | CRUSH+BOUNCE+ROCKET+BUBB | SLAM+UPPER+ROCKET+BUBB | TORN+UPPER+ROCKET+BUBB | CRUSH+UPPER+ROCKET+BUBB", 
			"SLAM+ROCKET | CRUSH+ROCKET | BOUNCE+ROCKET | TORN+ROCKET"
		),
        "Deep-Dish 9 Sausage Toppin": (
			...
			"SLAM+SJUMP+ROCKET | SLAM+CLIMB+ROCKET",  
			"SLAM+SJUMP+ROCKET+BUBB | TORN+SJUMP+ROCKET+BUBB | CRUSH+SJUMP+ROCKET+BUBB | SLAM+BOUNCE+ROCKET+BUBB | TORN+BOUNCE+ROCKET+BUBB | CRUSH+BOUNCE+ROCKET+BUBB | SLAM+UPPER+ROCKET+BUBB | TORN+UPPER+ROCKET+BUBB | CRUSH+UPPER+ROCKET+BUBB", 
			"SJUMP+BOUNCE+ROCKET | SJUMP+TORN+ROCKET | UPPER+BOUNCE+ROCKET | UPPER+TORN+ROCKET | CRUSH+ROCKET"
		),
        ...
        "Deep-Dish 9 Secret 2": (
			...
			"SLAM+SJUMP+ROCKET+BUBB | SLAM+CLIMB+ROCKET+BUBB", 
			"SLAM+SJUMP+ROCKET+BUBB | TORN+SJUMP+ROCKET+BUBB | CRUSH+SJUMP+ROCKET+BUBB | SLAM+BOUNCE+ROCKET+BUBB | TORN+BOUNCE+ROCKET+BUBB | CRUSH+BOUNCE+ROCKET+BUBB | SLAM+UPPER+ROCKET+BUBB | TORN+UPPER+ROCKET+BUBB | CRUSH+UPPER+ROCKET+BUBB", 
			"SJUMP+BOUNCE+ROCKET+BUBB | SJUMP+TORN+ROCKET+BUBB | UPPER+BOUNCE+ROCKET+BUBB | UPPER+TORN+ROCKET+BUBB | CRUSH+ROCKET+BUBB"
		),
        "Deep-Dish 9 Secret 3": (
			"SLAM+CLIMB+ROCKET+BUBB", 
			"SLAM+SJUMP+ROCKET | SLAM+CLIMB+ROCKET", 
			"SLAM+SJUMP+ROCKET+BUBB | TORN+SJUMP+ROCKET+BUBB | CRUSH+SJUMP+ROCKET+BUBB | SLAM+BOUNCE+ROCKET+BUBB | TORN+BOUNCE+ROCKET+BUBB | CRUSH+BOUNCE+ROCKET+BUBB | SLAM+UPPER+ROCKET+BUBB | TORN+UPPER+ROCKET+BUBB | CRUSH+UPPER+ROCKET+BUBB", 
			"SJUMP+SLAM+ROCKET | SJUMP+TORN+ROCKET | BOUNCE+ROCKET | CRUSH+ROCKET | UPPER+SLAM+ROCKET | UPPER+TORN+ROCKET"
		),
        ...
        "Chef Task: Man Meteor": (
			...
			"SJUMP+SLAM+ROCKET | UPPER+SLAM+ROCKET | CRUSH+SLAM+ROCKET | BOUNCE+SLAM+ROCKET"
		),
        "Deep-Dish 9 S Rank": (
			"SLAM+CLIMB+ROCKET+BUBB", 
			"SLAM+SJUMP+ROCKET | SLAM+CLIMB+ROCKET", 
    ...
    #Oh Shit!
        ...
        "Oh Shit! Mushroom Toppin": (
			"SLAM+STICKY", 
			"SLAM+STICKY", 
			"SLAM+STICKY | TORN+STICKY | CRUSH+STICKY", 
			"SLAM+STICKY | CRUSH+STICKY | BOUNCE+STICKY | TORN+STICKY"
		),
        "Oh Shit! Cheese Toppin": (
			"SLAM+CLIMB+STICKY | SLAM+SJUMP+STICKY | SLAM+UPPER+STICKY", 
			"SLAM+SJUMP+STICKY | SLAM+CLIMB+STICKY | SLAM+UPPER+STICKY", 
			"SLAM+BOUNCE+STICKY | TORN+BOUNCE+STICKY | CRUSH+STICKY | SLAM+SJUMP+STICKY | TORN+SJUMP+STICKY | SLAM+UPPER+STICKY | TORN+UPPER+STICKY", 
			"SJUMP+SLAM+STICKY | SJUMP+TORN+STICKY | BOUNCE+STICKY | CRUSH+STICKY | UPPER+SLAM+STICKY | UPPER+TORN+STICKY"
		),
    ...
    #WAR
        "WAR Complete": (
			"GRAB+SHOTGUN+SJUMP+SLAM", 
			"GRAB+SHOTGUN+SJUMP | GRAB+SHOTGUN+CLIMB | UPPER+SHOTGUN+SJUMP | UPPER+SHOTGUN+CLIMB | GRAB+SHOTGUN+SLAM | UPPER+SHOTGUN+SLAM", 
			"GRAB+SHOTGUN+SJUMP+SLAM | GRAB+SHOTGUN+SJUMP+CRUSH | GRAB+SHOTGUN+SJUMP+TORN", 
			"GRAB+SHOTGUN+SJUMP | UPPER+SHOTGUN+SJUMP | GRAB+SHOTGUN+SLAM | UPPER+SHOTGUN+SLAM | GRAB+SHOTGUN+CRUSH | UPPER+SHOTGUN+CRUSH"
		),
        "WAR Mushroom Toppin": (
        ...
        "WAR Tomato Toppin": (
			"GRAB+SHOTGUN+SJUMP+SLAM | GRAB+SHOTGUN+CLIMB+SLAM", 
			"GRAB+SHOTGUN+SJUMP | GRAB+SHOTGUN+CLIMB | UPPER+SHOTGUN+SJUMP | UPPER+SHOTGUN+CLIMB | GRAB+SHOTGUN+SLAM | UPPER+SHOTGUN+SLAM", 
			"GRAB+SHOTGUN+BOUNCE+SLAM | GRAB+SHOTGUN+BOUNCE+CRUSH | GRAB+SHOTGUN+BOUNCE+TORN | GRAB+SHOTGUN+SJUMP+SLAM | GRAB+SHOTGUN+SJUMP+CRUSH | GRAB+SHOTGUN+SJUMP+TORN", 
			"GRAB+SHOTGUN+CRUSH | GRAB+SHOTGUN+SJUMP | GRAB+SHOTGUN+BOUNCE | GRAB+SHOTGUN+SLAM | UPPER+SHOTGUN+CRUSH | UPPER+SHOTGUN+SJUMP | UPPER+SHOTGUN+BOUNCE | UPPER+SHOTGUN+SLAM"
		),
        "WAR Sausage Toppin": (
			"GRAB+SHOTGUN+SJUMP+SLAM | GRAB+SHOTGUN+CLIMB+SLAM", 
        ...
        "Chef Task: Trip to the Warzone": (
			"GRAB+SHOTGUN+SJUMP+SLAM", 
			"GRAB+SHOTGUN+SJUMP | GRAB+SHOTGUN+CLIMB | UPPER+SHOTGUN+SJUMP | UPPER+SHOTGUN+CLIMB | GRAB+SHOTGUN+SLAM+MACH4 | UPPER+SHOTGUN+SLAM+MACH4", 
			"GRAB+SHOTGUN+SJUMP+SLAM | GRAB+SHOTGUN+SJUMP+CRUSH | GRAB+SHOTGUN+SJUMP+TORN", 
			"GRAB+SHOTGUN+SJUMP | UPPER+SHOTGUN+SJUMP | GRAB+SHOTGUN+CRUSH | UPPER+SHOTGUN+CRUSH"
		),
    ...
    #Crumbling Tower of Pizza
        "The Crumbling Tower of Pizza Complete": (
			"SLAM+SJUMP+CLIMB+GRAB+SHOTGUN", 
			"GRAB+SLAM+SJUMP+SHOTGUN | GRAB+SLAM+CLIMB+SHOTGUN | UPPER+SLAM+SJUMP+SHOTGUN | UPPER+SLAM+CLIMB+SHOTGUN", 
			"GRAB+SHOTGUN+SJUMP+SLAM | GRAB+SHOTGUN+SJUMP+TORN | GRAB+SHOTGUN+SJUMP+CRUSH", 
			"SJUMP+GRAB+SHOTGUN+SLAM | SJUMP+GRAB+SHOTGUN+TORN | SJUMP+GRAB+SHOTGUN+BOUNCE | CRUSH+GRAB+SHOTGUN | SJUMP+UPPER+SHOTGUN+SLAM | SJUMP+UPPER+SHOTGUN+TORN | SJUMP+UPPER+SHOTGUN+BOUNCE | CRUSH+UPPER+SHOTGUN"
		),
    ...
    #pumpkins
        ...
        "WAR Pumpkin": (
			"GRAB+SJUMP+SLAM+SHOTGUN | GRAB+CLIMB+SLAM+SHOTGUN", 
			"GRAB+SJUMP+SHOTGUN | GRAB+CLIMB+SHOTGUN | UPPER+SJUMP+SHOTGUN | UPPER+CLIMB+SHOTGUN | GRAB+SLAM+SHOTGUN | UPPER+SLAM+SHOTGUN", 
			"GRAB+BOUNCE+SHOTGUN | GRAB+SJUMP+SHOTGUN", 
			"GRAB+CRUSH+SHOTGUN | GRAB+SJUMP+SHOTGUN | GRAB+BOUNCE+SHOTGUN | GRAB+SLAM+SHOTGUN | UPPER+CRUSH+SHOTGUN | UPPER+SJUMP+SHOTGUN | UPPER+BOUNCE+SHOTGUN | UPPER+SLAM+SHOTGUN"
		),
