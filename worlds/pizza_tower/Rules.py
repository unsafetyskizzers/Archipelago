...
def set_rules(multiworld: MultiWorld, world: World, options: PTOptions, toppins: int, pumpkins: int):
    ...
    #Crumbling Tower of Pizza
        "The Crumbling Tower of Pizza Complete": (
			...
			"GRAB+SLAM+SJUMP+SHOTGUN+WEEN+ROCKET+BUBB | GRAB+SLAM+CLIMB+SHOTGUN+WEEN+ROCKET+BUBB", 
			...
			"SJUMP+GRAB+SHOTGUN+SLAM+WEEN+ROCKET+BUBB | SJUMP+GRAB+SHOTGUN+TORN+WEEN+ROCKET+BUBB | SJUMP+GRAB+SHOTGUN+BOUNCE+WEEN+ROCKET+BUBB | CRUSH+GRAB+SHOTGUN+WEEN+ROCKET+BUBB"
		),
